...
eTutor!" – Lisa, Parent`
  ...
  return (
    ...
    <div className=' px-5 my-[203px] mb-64 mb:px-0 lg:px-5 mb:my-4 lg:my-24 xl:my-36'>
      <Headings className='ml-2.5' heading=' “ Loved by parents & students' />
      <p className='text-darkBlue mt-6 text-[27px] mb:text-base ml-9' >98% of our parents say their students made significant progress</p>
