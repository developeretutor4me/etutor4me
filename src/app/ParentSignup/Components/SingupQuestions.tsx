              ...
              onClick={() => {
                if(!selectedGrade){
                  ...
                  toast({
                    ...
                    description: "Please select a grade to proceed.",
                    variant: "default",
                  });
            ...
            <ConfirmBtn
              onClick={() => {
                if(!selectedGrade){
                  ...
                  toast({
                    title: "Missing Fields!",
                    description: "Please select a Level to proceed.",
                    variant: "default",
                  });
              ...
              {selectedSubjects.length > 0 && (
                <div className="flex flex-wrap items-start justify-start gap-2 mt-3 sm:mt-5 custom-xl:mt-8   px-2 custom-xl:px-6 mx-auto min-h-[3.4rem]">
                  {selectedSubjects.map((subject) => (
                    <span
                      key={subject}
                      className="bg-[#6C5BAA] text-white text-xs custom-xl:text-xl px-5 py-2 custom-2xl:py-2.5 rounded-full flex items-center  gap-7  justify-between"
                    >
                      {subject}
                      <X
                        className="ml-2 h-4 custom-2xl:h-6 w-4 custom-2xl:w-6 cursor-pointer"
            ...
            <ConfirmBtn
              onClick={() => {
                if(selectedSubjects.length<=0){
                  ...
                  toast({
                    title: "Missing Fields!",
                    description: "Please select a subject to proceed.",
                    variant: "default",
                  });
              ...
              <ConfirmBtn
                onClick={() =>{
                  if(!ChildLastName || !ChildsFirstName || !Age || !selectedCountry || !selectedcity || !streetname || !zipcode || !institue){
                    toast({
                      title: "Missing Fields!",
                      description: "Please ensure all fields are filled out before proceeding.",
                      variant: "default",
                    });
        ...
        return (
          <div className=" rounded-3xl bg-questionbg py-14 px-16 w-full lg:p-8 mb:w-full mb:p-6 max-w-[80rem] -mt-9">
            ...
            <div className="relative my-24 mb:my-5">
              <textarea
                className="font-bold  bg-purpleBtn placeholder-[#9085C4]  text-darkBlue w-full rounded-2xl p-4 border-gray-500 border focus:border-blue-500 focus:outline-none mb:text-xs"
                value={text}
