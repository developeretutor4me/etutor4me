...
const MembershipPlans = ({ plandata }: MembershipPlansprops) => {
  ...
  const standardplan: any = [
    ...
    },
    {
      ...
      discountValue:0,
      description:
        "4 Sessions/Month-(16-Sessions) (Level 1-3) (Every 4-Months Auto-Renewal)",
    },
    {
      type: "Standard Membership",
      level: "Senior",
      ...
      discountValue:0,
      description:
        "4 Sessions/Month-(16-Sessions) (Level 4-7) (Every 4-Months Auto-Renewal)",
    },
    {
      type: "Standard Membership",
      level: "Expert",
      ...
      discountValue:0,
      description:
        "4 Sessions/Month-(16-Sessions) (Level 8-10) (Every 4-Months Auto-Renewal)",
    },
    {
      type: "Standard Membership",
      level: "Junior",
      ...
      discountValue:0,
      description:
        "4 Sessions/Month-(36-Sessions) (Level 1-3) (Every 9-Months Auto-Renewal)",
    },
    {
      type: "Standard Membership",
      level: "Senior",
      ...
      discountValue:0,
      description:
        "4 Sessions/Month-(36-Sessions) (Level 4-7) (Every 9-Months Auto-Renewal)",
    },
    {
      type: "Standard Membership",
      level: "Expert",
      ...
      discountValue:0,
      description:
        "4 Sessions/Month-(36-Sessions) (Level 8-10) (Every 9-Months Auto-Renewal)",
    },
  ];
  const premiumplan: any = [
    ...
    },
    {
      ...
      discountValue:0,
      description:
        "8 Sessions/Month-(32-Sessions) (Level 1-3) (Every 4-Months Auto-Renewal)",
    },
    {
      type: "premium Membership",
      level: "Senior",
      ...
      discountValue:0,
      description:
        "8 Sessions/Month-(32-Sessions) (Level 4-7) (Every 4-Months Auto-Renewal)",
    },
    {
      type: "premium Membership",
      level: "Expert",
      ...
      discountValue:0,
      description:
        "8 Sessions/Month-(32-Sessions) (Level 8-10) (Every 4-Months Auto-Renewal)",
    },
    {
      type: "premium Membership",
      level: "Junior",
      ...
      discountValue:0,
      description:
        "8 Sessions/Month-(72-Sessions) (Level 1-3) (Every 9-Months Auto-Renewal)",
    },
    {
      type: "premium Membership",
      level: "Senior",
      ...
      discountValue:0,
      description:
        "8 Sessions/Month-(72-Sessions) (Level 4-7) (Every 9-Months Auto-Renewal)",
    },
    {
      type: "premium Membership",
      level: "Expert",
      ...
      discountValue:0,
      description:
        "8 Sessions/Month-(72-Sessions) (Level 8-10) (Every 9-Months Auto-Renewal)",
    },
  ];
  ...
  const handleSave = async () => {
    ...
    if (editIndex !== null && newPrice !== null) {
      ...
      setPlans((prevPlans: any) =>
        prevPlans.map((plan: any, i: any) =>
          i === editIndex ? updatedPlan : plan
        )
      );
      ...
      <div className="relative   h-fit   w-full custom-xl:w-fit mt-1 ">
        ...
        {isOpen && (
          ...
          >
            <ul
              id="style-2"
              className=" overflow-y-auto max-h-[14rem] scrollstyle   "
            >
              {options.map((option) => (
                <li
                  onClick={() => {
      ...
      <div>
        {editIndex != null && (
          ...
          <button onClick={()=>{
            setEditIndex(null);
            setNewPrice(null);
          }} className="font-medium text-2xl px-6 py-3 rounded-md bg-[#FC7777] text-white ">Cancel</button>
        )}
      </div>
      </div>
