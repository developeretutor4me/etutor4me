...
import NotificationPage from "./components/NotificationBox";
  ...
  const renderContent = () => {
    switch (activeSidebarItem) {
      ...
      case "Dashboard":
        return (
          <div className="  h-fit    ">
  <div className={`absolute z-50 top-20 custom-2xl:top-28 mr-1 sm:mr-0 sm:right-[29px] duration-1000 transition-all ease-in-out ${isOpenNoti ? "translate-x-0":"translate-x-[120%]"} `}>
                <NotificationPage />
              </div>
            {/* <Dashboard /> */}
                  ...
                  >
                    ...
                    {redeem && (
                      <div className="hover absolute w-[340px] h-[150px] top-0 left-40 rounded-lg p-4 text-start bg-[#8450ff] text-xl overflow-auto scrollbar-none">
                        ...
                        elit. Odit, unde? Quos reprehenderit non est, quis
                        aliquid necessitatibus illum porro ex ipsa.
                        Voluptatibus, nostrum ratione rerum numquam dolore, non
                        tempore iste consequatur vel vitae ab recusandae qui
                        necessitatibus ea officiis amet.
                      </div>
                    )}
                  </button>
                </div>
      ...
      case "My eTutor":
        return (
          <MyEtutor
            ...
            showchatvalue={chat}
            setActiveFindEtutor={setActiveSidebarItem}
            setTutor={setTutor} showTerminateEngament={setterminateeng}          />
        );
      case "Find eTutor":
        return (
          <div>
            <FindEtutor
              ...
              showchat={setchat}
              trialrequest={Trial}
              parentdata={parentData} sessionData={sessionData} showTerminateEngament={terminateeng}            />
          </div>
        );
      case "My Membership":
      ...
      case "Contact Support":
        // @ts-ignore
        return <ContactSupport profilePicture={profilePicture || FetchedUserData?.profilePicture} name={firstName} />;
