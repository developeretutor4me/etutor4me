...
const DashboardGrid = ({
  ...
  return (
    <div className={styles.gridContainer}>
      ...
      <div className={`${styles.calendar} px-[26px] py-4 rounded-2xl`}>
        <div className="flex  justify-between items-center px-1">
            ...
            {calendarDays.map((day, index) => {
              ...
              return (
                <div
                  ...
                  key={index}
                  className={`flex items-center justify-center rounded-full  relative   custom-xl:rounded-full  text-center  mx-auto mt-3  ${
      ...
      <div
        className={`${styles.referFriends} px-[25px] py-4 rounded-2xl flex flex-col justify-between`}
      >
        <div className="flex  justify-between items-center ">
      ...
      <div className={`${styles.support} px-[26px] py-4 rounded-2xl flex flex-col justify-between`}>
        <div className="flex  justify-between items-center px-1">
          <h1 className="font-bold text-[25px] text-[#685AAD]">24H SUPPORT</h1>
          <Image loading="lazy" src={chaticon} alt="" className="w-[25.4px] h-[25.4px]" />
        </div>
      ...
      <div className={styles.trialSession}>
        <div className="flex  flex-col">
          <h1 className="font-bold text-xl uppercase">Trial Session</h1>
        ...
        <div className="overflow-y-auto  h-[92%] scrollbar-none">
          <div className="border-b-2 border-[#8b55ff39] py-2 ">
            ...
            <p className="text-xs text-[#685AAD]">
              Lorem ipsum, dolor sit amet consectetur adipisicing elittetur
              adipisicing elittetur{" "}
            </p>
          </div>
          <div className="border-b-2 border-[#8b55ff39] py-2 ">
            <h1 className="text-sm text-[#685AAD]">MR.Name</h1>
