      ...
      <div className="bg-[#EDE8FA] rounded-3xl py-7 custom-2xl:py-14 px-6 custom-2xl:px-12">
            ...
            <div className="bg-[#B4A5D7] mt-6 custom-2xl:mt-12 py-3 sm:py-6 custom-2xl:py-12 px-3 sm:px-12 custom-2xl:px-24 rounded-3xl space-y-8">
                    ...
                    <div className="mt-1 flex items-center justify-between">
                        ...
                        <Image  loading="lazy"  src={level1} alt="" className="w-6 sm:w-12 sm:h-12 custom-2xl:w-[112px] custom-2xl:h-[112px] " />
                    ...
                    <div className="mt-1 flex items-center justify-between">
                        ...
                        <div className="flex items-start custom-2xl:items-center gap-2 sm:gap-4 flex-col custom-2xl:flex-row custom-2xl:gap-[109px] ">
                        <Image  loading="lazy"  src={level2} alt="" className="w-6 sm:w-12 sm:h-12 custom-2xl:w-[112px] custom-2xl:h-[112px]" />
                    ...
                    <div className="mt-1 flex items-center justify-between">
                        ...
                        <div className="flex items-start custom-2xl:items-center gap-2 sm:gap-4 flex-col custom-2xl:flex-row custom-2xl:gap-[109px] ">
                        <Image  loading="lazy"  src={level3} alt="" className="w-6 sm:w-12 sm:h-12 custom-2xl:w-[112px] custom-2xl:h-[112px]" />
                    ...
                    <div className="mt-1 flex items-center justify-between">
                        ...
                        <div className="flex items-start custom-2xl:items-center gap-2 sm:gap-4 flex-col custom-2xl:flex-row custom-2xl:gap-[109px] ">
                        <Image  loading="lazy"  src={level4} alt="" className="w-6 sm:w-12 sm:h-12 custom-2xl:w-[112px] custom-2xl:h-[112px]" />
