...
const HeroSection = () => {
  ...
  return (
    <div className='  w-full flex items-center justify-between  h-lvh mb:flex-col mb:flex mb:items-center mb:text-center mb:justify-center mb:gap-10 px-8 mb:py-8 mb:h-full  ' >
      <div className='w-[50%] lg:w-[45%] mb:w-full'>
        <h2 className=' font-extrabold text-[61px]  mb:text-3xl lg:text-4xl xl:text-4xl leading-[1.19] mt-5 custom-lg:max-w-[80%]'>
      ...
      <div className='w-[57%] mb:w-full  2xl:-mt-14  hidden custom-lg:block '>
        <Image loading="lazy" alt='' src={img}  className=''/>
      </div>
    </div>
  )
}
