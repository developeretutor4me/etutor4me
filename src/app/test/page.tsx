...
export default function MySessionComp() {
  ...
  return (
      <div className="relative w-full max-w-[1448.64px] mt-[100px]  min-h-[22rem]">
        {/* Individual Tab */}
        <div
        ...
        <div className="absolute top-0 left-0 w-full h-full z-[20]  ">
          <div
            ...
            className={`relative  w-full max-w-[400px]  custom-2xl:max-w-[1000px]  h-[857px] top-0 left-[287px] rounded-[20px] rounded-tl-none hover:cursor-pointer`}
        ...
        <div className="absolute top-0 left-0 w-full h-full z-[10]">
          <div
            ...
            className={`relative  w-full max-w-[200px] custom-xl:max-w-[600px] h-[857px] top-0 left-[619px] rounded-[20px] rounded-tl-none hover:cursor-pointer`}
