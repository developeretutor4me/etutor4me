...
const AddChildSection = () => {
  ...
  const handleLink = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "/api/parent-Student-Relationship/parent-side-api/Link",
        {
          method: "POST",
          headers: {
  ...
  const handleVerify = async (e: any) => {
    ...
    try {
      const response = await fetch(
        "/api/parent-Student-Relationship/parent-side-api/verify",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="">
      <div className="px-11 py-11 flex sm:items-center flex-col sm:flex-row gap-4 sm:gap-10">
        ...
        <Image  loading="lazy"  src={singup} alt="" className="absolute -bottom-32 z-50 left-0 w-[35rem] hidden 2xl:block" />
      </div>
      ...
      {selectedOption === "select" && (
        <div className="my-auto mx-auto 2xl:absolute top-44 right-36 w-full max-w-[1408px] min-h-[658px]  px-16 py-16 bg-[#ede8fa] rounded-3xl ">
          ...
          <p className="text-[#8276bc] text-xl mb-12 max-w-6xl leading-tight font-semibold ">
            Easily manage your child&apos;s learning by adding them to your
            parent account. Select whether your child has an existing account or
            needs a new one to continue.
          </p>
          ...
          <div className="grid custom-lg:grid-cols-2 gap-8  pt-2 ">
            ...
            >
              ...
              <p className="text-[#8274bc] text-xl pb-2  font-roboto">
                If your child already has an account on our platform, you can
                easily link it to your parent account. Simply enter your
                child&apos;s account details to establish a connection and
                manage their learning from your profile. This will allow you to
                track progress, assign tutors, and receive updates about your
                child&apos;s activities.
              </p>
            </div>
            ...
            >
              ...
              <div className="h-0.5 w-[73%] bg-[#685AAD] mb-6"></div>
              <p className="text-[#8274bc] text-xl pb-2  font-roboto">
                If your child is new to our platform, you can create a new
                account for them directly. Fill in the required details to set
                up their profile and begin their learning journey. You&apos;ll
                be able to manage their account, assign tutors, and monitor
                their progress from your parent account.
              </p>
            </div>
          </div>
        </div>
      ...
      {selectedOption === "linkAccount" && (
        <div className="my-auto mx-auto 2xl:absolute top-36 right-44 w-full max-w-[1214px] min-h-[717px]  px-20 py-16 bg-[#ede8fa] rounded-3xl">
          ...
          <p className="text-[#8276bc] text-xl mb-12 max-w-6xl leading-tight font-semibold ">
            Connect your child’s existing account to your parent profile. Simply
            enter their account details to complete the link.
          </p>
                ...
                {errorMessage && (
                  <>
                    ...
                    <p className="text-[#ff9580] text-lg leading-tight ">
                      The email or ID you entered is incorrect. Please enter the
                      correct info to proceed
                    </p>
                  </>
                )}
              </div>
      ...
      {selectedOption === "confirmation" && (
        <div className="my-auto mx-auto 2xl:absolute top-48 right-44 w-full max-w-[1214px] min-h-[566px]  px-20 py-16 bg-[#ede8fa] rounded-3xl">
          ...
          <p className="text-[#8276bc] text-xl mb-9 max-w-[57rem] leading-tight font-semibold ">
            A confirmation code was sent to your child’s email address. Please
            enter the code below to complete the account link.
          </p>
              ...
              <div className="flex items-center max-w-[36rem] gap-9 pl-8">
                {error && (
                  <>
                    <Image  loading="lazy"  src={alert} alt="" className="w-11" />
                    <p className="text-[#ff9580] text-lg leading-tight ">
                      The confirmation code you entered is incorrect. Please
      ...
      {selectedOption === "AccountLink" && (
        <div className="my-auto mx-auto 2xl:absolute top-24 right-40 w-full max-w-[975px] min-h-[897px]  px-[6.5rem] py-16 bg-[#ede8fa] rounded-3xl ">
          ...
          <p className="text-[#8276bc] text-xl mb-12 max-w-6xl leading-tight font-semibold ">
            You’re about to link your account to the following student profile.
      ...
      {selectedOption === "success" && (
        <div className="my-auto mx-auto 2xl:absolute top-[13.5rem] right-[11.4rem] w-full max-w-[1111.92px] min-h-[471px]  px-[6.5rem] py-20 bg-[#ede8fa] rounded-3xl ">
          ...
          <p className="text-[#8276bc] text-xl mb-12 max-w-6xl leading-tight font-semibold ">
            The student account has been successfully linked to your parent
            profile. You can now manage their learning journey and access their
            progress directly.
          </p>
