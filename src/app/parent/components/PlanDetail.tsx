  ...
  return (
    <>
      <div className="bg-white rounded-3xl custom-xl:rounded-[45px]  overflow-hidden border border-black   drop-shadow-[0px_5px_0px_#b0a9c4] sm:drop-shadow-[0px_15px_0px_#b0a9c4] custom-lg:drop-shadow-[0px_20px_0px_#b0a9c4] ">
        <div
          className={`${bgColor}  text-white py-4 custom-xl:py-[30px] flex items-center justify-center px-2 sm:px-4  text-3xl custom-2xl:text-[58px] custom-2xl:leading-none font-bold border-b border-black`}
        >
        ...
        <div className="px-4 sm:px-10 custom-xl:px-12  py-3 sm:py-6 custom-xl:py-8 mb-4">
          {plan != "bundles" ? (
            <>
              <div className="flex  gap-2 sm:gap-4 max-w-[74rem] w-full mx-auto items-start custom-xl:items-center flex-col custom-xl:flex-row custom-xl:justify-between custom-xl:flex-wrap ">
                <div className="flex flex-col items-center justify-center border-r-0 custom-2xl:border-r-2 border-[#e0d4ff] custom-2xl:max-w-[21.2rem] ">
                  <h2 className="text-[#9C78F9]  text-2xl  custom-xl:text-4xl custom-2xl:text-[58.74px] custom-2xl:leading-tight font-bold ">
                    Choose your Preferences
                  </h2>
                </div>

                <div className="flex flex-col items-start justify-center gap-y-0 lgsm:gap-y-4 custom-2xl:gap-y-8  ">
                  <div className="text-[#8653ff] text-lg  custom-xl:text-2xl custom-2xl:text-[54.25px] custom-2xl:leading-[2.25rem] font-medium ">
                    <span className="font-bold">
                      {" "}
                      <span className=" text-xl  custom-xl:text-3xl custom-2xl:text-[75.48px] custom-2xl:leading-none">
                        {" "}
                        {sessions}{" "}
                      </span>{" "}
                      Sessions
                    </span>{" "}
                    <span className=" text-sm sm:text-xl custom-2xl:text-4xl">
                      {" "}
                      / month
                    </span>
                  </div>
                  <div className="text-[#8653ff] text-sm sm:text-lg custom-xl:text-2xl custom-2xl:text-[43.14px] custom-2xl:leading-[2.25rem] font-medium ">
                    <span className="font-bold text-xl custom-xl:text-3xl custom-2xl:text-[69.51px] custom-2xl:leading-none">
                      {" "}
                      ${price}.00
                    </span>
                    <span>/ month</span>
                ...
                <div className="  flex flex-col items-start justify-center gap-y-0 sm:gap-y-3 custom-2xl:gap-y-6 ">
                  <div className="text-[#53497F] text-lg custom-2xl:text-2xl  ">
              ...
              <div className="mb-[62px] flex  custom-2xl:items-end  justify-between flex-col custom-2xl:flex-row ">
                <div className="px-2">
                  <div className="custom-xl:my-5 ">
                    <h3 className="text-[#685aad]  py-4  custom-xl:py-8 px-0 sm:px-0.5   text-2xl custom-2xl:text-[39.74px] custom-2xl:leading-[2.25rem] font-bold">
                      Package duration
                    </h3>
                    <div className="flex flex-wrap gap-3 mt-0.5 pl-1">
                      {["monthly", "4 months", "9 months"].map((duration) => (
                        <button
                          ...
                          } py-2 sm:py-3 px-[68px] rounded-full text-sm sm:text-xl custom-2xl:text-[32.98px] custom-2xl:leading-[2.25rem]  transition-all   `}
                        >
                          {duration}
                        </button>
                      ))}
                  ...
                  <div className=" ">
                    <h3 className="text-[#685aad]  py-4  custom-xl:py-7 px-0 sm:px-0.5   text-2xl custom-2xl:text-[39.74px] custom-2xl:leading-[2.25rem] font-bold">
                      eTutor&apos;s Level
                    </h3>
                    <div className="flex flex-wrap gap-3 px-1">
                      {[
                        ...
                        <button
                          ...
                          }  py-2 sm:py-3.5 px-[75px] rounded-3xl  text-sm sm:text-xl custom-2xl:text-3xl  transition-all `}
                        >
                ...
                <div className="bg-[#f4f1fd] px-2 sm:px-7  py-4 sm:py-10 rounded-3xl custom-xl:rounded-[45px]  max-w-[379px] w-full h-[325px]  flex flex-col justify-between mt-5">
                  <div className=" px-6 ">
                    <p className="flex flex-col pb-4">
                      <span className="text-[#685aad]     text-sm sm:text-xl custom-2xl:text-[32px] custom-2xl:leading-[2.25rem] font-bold">
                        Package duration
                      </span>
                      <span className="text-[#8653ff] text-lg custom-2xl:text-[27px] custom-2xl:leading-[2rem] font-medium mt-1.5">
                        {selectedDuration}
                      </span>
                    </p>
                    <p className="flex flex-col pb-4 ">
                  ...
                  <div className="px-6">
                    <p className=" mt-2">
                      ...
                      <span className="text-[#8653ff]      text-sm sm:text-xl custom-2xl:text-[32px] custom-2xl:leading-[2.25rem] font-bold mt-1.5">
                        {" "}
                        ${price} / m
                      </span>
                    </p>
          ...
          <div className="flex items-end  justify-between  flex-col custom-xl:flex-row pt-2">
            <div className="text-[#625598] text-start max-w-[46rem] text-sm sm:text-md custom-2xl:text-xl pt-5 sm:pt-16">
            ...
            <div className="flex flex-col items-start justify-center  pt-1  w-full max-w-[398.73px]">
              <div className="mb-3">
                <input
                  ...
                  type="checkbox"
                  id="terms"
                  className="mr-2 text-md custom-2xl:text-xl hover:cursor-pointer checked:bg-red-500 checked "
                />
                <label
                  htmlFor="terms"
                  className="text-[#53497F] text-xs sm:text-lg custom-2xl:text-[22.19px] custom-2xl:leading-[2rem]"
                >
                  I agree with the{" "}
              ...
              <button
                className={`w-full bg-[#8653FF] text-white py-2 sm:py-3 rounded-full  text-sm sm:text-xl custom-2xl:text-4xl font-semibold`}
                onClick={() => {
