...
function ProfileView({
    ...
    async function isTutorSessionExist(sessionData: any, tutorId: any) {
        return sessionData?.some(
            (request: any) => request?.teacher?._id === tutorId
        );
    }
    return (
                ...
                <div className="bg-[#A296CC] rounded-3xl p-10 ">
                    ...
                    <div className="bg-[#685AAD] py-3 sm:py-6 px-2 sm:px-4 rounded-xl font-sans relative mb-4">
                        <button
                            ...
                            className={`w-full bg-purple-600 text-[#B3ACD6] py-3 px-4 rounded-lg flex justify-between items-center ${ismemberOpen && "text-white"
                                }`}
                        >
                    ...
                    <div className="bg-[#685AAD] py-3 sm:py-6 px-2 sm:px-4 rounded-xl font-sans relative mb-4">
                        ...
                        >
                            <span
                                className={`text-xl font-bold ${isDurationOpen && "text-white transition-all duration-300 text-nowrap"
                                    }`}
                            >
                                {selectedDuration ? (
                                    <span className="text-white">
