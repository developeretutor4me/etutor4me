...
import MySessionComp from "./MySessionComp";
...
const SessionDashboard = ({
  ...
  return (
    <>
      {/* <MySessionComp /> */}
      <div className="w-full  h-full pt-4 bg-[#EDE8FA]  rounded-[35px]   relative mt-10">
                          ...
                          {requests
                            ...
                            .map((request: any) => {
                              ...
                              return (
                                <div
                                  key={request._id}
                                  className={`w-full transition-all duration-300 ease-in-out bg-[#564589] rounded-lg custom-2xl:pl-9  ${isExpanded
                                    ...
                                    <div className="flex-1 p-4 flex flex-col custom-2xl:flex-row items-start custom-2xl:items-center">
                                      <div className="grid grid-cols-2 custom-2xl:grid-cols-4 gap-4 w-full">
                                        ...
                                        <div className="flex flex-col custom-2xl:block custom-2xl:pt-2">
                                          ...
                                          <div
                                            className={`text-xl text-white ${isExpanded
                                              ? "opacity-100 block transition-all duration-300 ease-in-out"
                                              : "opacity-0 hidden transition-all duration-300 ease-in-out"
                                              }`}
                                          >
                          ...
                          >
                            ...
                            <div className="flex flex-col items-center gap-6 w-full custom-xl:w-auto">
                              <div className="flex gap-4">
                                <button
                                  onClick={() => {
                                    setWaiting({ id: teacher._id, action: "rejected" });
                                ...
                                >
                                  ...
                                  {waiting.id === teacher._id && waiting.action === "rejected" ? "Wait..." : "Deny"}
                                </button>

                                <button
                                  onClick={() => {
                                    setWaiting({ id: teacher._id, action: "accepted" });
                                ...
                                >
                                  ...
                                  {waiting.id === teacher._id && waiting.action === "accepted" ? "Wait..." : "Accept"}
                                </button>
                              </div>
